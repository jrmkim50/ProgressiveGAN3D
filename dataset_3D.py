...
#----------------------------------------------------------------------------
# Parse individual volume from a tfrecords file.
...
class TFRecordDataset:
    def __init__(self,
        ...
        with tf.name_scope('Dataset'), tf.device('/cpu:0'):
            ...
            tfutil_3D.set_vars({self._tf_labels_var: self._np_labels})
    ...
    def configure(self, minibatch_size, lod=0):
        ...
        if self._cur_minibatch != minibatch_size or self._cur_lod != lod:
            tfutil_3D.run(self._tf_init_ops[lod], feed_dict={self._tf_minibatch_in: minibatch_size})
    ...
    def get_minibatch_np(self, minibatch_size, lod=0): # => images, labels
        ...
        return tfutil_3D.run(self._tf_minibatch_np)
...
class SyntheticDataset:
    def __init__(self, resolution=128, num_channels=3, dtype='uint16', dynamic_range=[0,65535], label_size=0, label_dtype='float32'):
    ...
    def configure(self, minibatch_size, lod=0):
        ...
        tfutil_3D.set_vars({self._tf_minibatch_var: minibatch_size, self._tf_lod_var: lod})
    ...
    def get_random_labels_np(self, minibatch_size): # => labels
        ...
        return tfutil_3D.run(self._tf_labels_np)
