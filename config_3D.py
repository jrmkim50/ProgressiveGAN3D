...
desc += '-preset-v2-1gpu'; num_gpus = 1; sched.minibatch_base = 4; sched.minibatch_dict = {4: 64, 8: 32, 16: 16, 32: 16, 64: 4}; sched.G_lrate_dict = {1024: 0.0015}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 120000
sched.tick_kimg_dict = {4: 20, 8:20, 16:20, 32:20, 64:20}; sched.lod_training_kimg = 100; sched.lod_transition_kimg = 100
